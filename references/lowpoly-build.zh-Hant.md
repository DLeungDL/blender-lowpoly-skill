...
5. 鬃和尾是**分開的深色塊**，不是毛髮粒子。
6. 材質：身體、鬃／尾、白章、蹄、眼。全部 Shade Flat。
7. 原點在蹄／地面。

跑步循環（只有被要求時才做）：複製 mesh 或用骨架擺 **四個命名姿勢** — `gathered`、`extended`、`airborne`、`landing`。轉整條腿。不要為變形加面。

不要：Auto Smooth、Subdivision、貼圖馬、鼻孔空腔、一根根毛。
